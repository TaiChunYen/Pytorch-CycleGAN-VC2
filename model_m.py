...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.upSample2 = upSample_Generator(in_channels=512,
                                            out_channels=512,
                                            kernel_size=5,
                                            stride=1,
                                            padding=2)
    ...
    def forward(self, input):
        ...
        downsample2 = self.downSample2(conv1)#
        #pdb.set_trace()
        ...
        upSample_layer_2 = self.upSample2(residual_layer_6)#
        #pdb.set_trace()
